...
M�dulo:        DrawComboBox
Versi�n:       1.0
Descripci�n:   Conjunto de ComboBox con opciones para dibujo. FREEWARE
Autor:         Favio E. Ugalde Corral
Creaci�n:      10 de diciembre  de 1996
Modificaci�n:  18 de septiembre de 1997
...
begin
  ...
  // Carga la lista de ashurados
  BuildList;
  // Estilo de relleno seleccionado por omisi�n
...
begin
  with Canvas do
    begin
    // Borra el cuadro de selecci�n con el color actual
    FillRect(Rect);
    // El pr�ximo cuadro del elemento ser� con contorno gris
    Pen.Color := clGray;
    ...
    case TBrushStyle(Index) of
      bsHorizontal:    // Con l�neas horizontales
        // Dibuja dos l�neas horizontales sobre el cuadro del elemento
        with Rect do
          begin
      ...
      bsCross:         // Con dibujos a cuadros
        ...
        // El pr�ximo cuadro del elemento ser� con relleno gris
        Brush.Color := clGray;
        // Dibuja el cuadro del elemento con l�neas verticales
...
begin
  ...
  FMaxLineStyle := Value;
  // Carga la lista de tipos de l�nea
  BuildList;
...
begin
  ...
  // Carga la lista de tipos de l�nea
  BuildList;
  // Estilo de l�nea seleccionado por omisi�n
...
begin
  with Canvas do
    ...
    // Se utiliza una pluma gris y cont�nua
    with Pen do
      begin
      Style := psSolid;
      Color := clGray;
    ...
    // Dibuja una l�nea al centro del cuadro con el tipo especificado en "Index"
...
begin
  // Guarda el estilo de l�nea seleccionado
  if ItemIndex >= 0 then
...
begin
  ...
  FMaxLineWidth := Value;
  // Carga la lista de anchos de l�nea
  BuildList;
...
begin
  with Canvas do
    ...
    // Se utiliza una pluma gris del ancho por omisi�n
    with Pen do
      begin
      Width := 0;
      Color := clGray;
    ...
    // Dibuja una l�nea al centro del cuadro con el ancho especificado en "Index"
    Pen.Width := Index + 1;
    with Rect do
      begin
      X := Left + 6 + Pen.Width;
...
begin
  // Guarda el ancho de l�nea seleccionado
  if ItemIndex >= 0 then
...
begin
  ...
  ItemHeight := 17;
  Height := 23;
  // Por omisi�n selecciona el color negro
  FColorValue := clBlack;
  // Por omisi�n muestra s�lo el color
...
// Carga la lista de colores por omisi�n
...
begin
  ...
  // Carga la lista de colores por omisi�n
  BuildList;
  // Color seleccionado por omisi�n
...
begin
  ...
  if FShowStyle = ssOnlyText then     // Mostrar s�lo texto
    inherited
  else
    begin
    // Color del elemento
    ...
    if FShowStyle = ssOnlyColor then  // Mostrar s�lo color
      Dec(ARect.Right, 4)
...
var
  nuHeight: Integer;
begin
  // Establece un alto m�nimo de 9 pixeles
